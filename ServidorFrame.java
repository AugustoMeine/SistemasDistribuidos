...
public class ServidorFrame extends JFrame{
    ...
    public static void main(String[] args){
        ...
        try {
            Servidor.servidor = new ServerSocket(1235);
            ServidorFrame.areaExibicaoTexto.setText(ServidorFrame.areaExibicaoTexto.getText() + "\n" +
            "Servidor iniciado: " + Servidor.servidor.getLocalPort());
            while (true) {
                Servidor.cliente = Servidor.servidor.accept(); //bloqueante
                ...
                Thread threadLeitora = new Thread(){
                    ...
                    public void run(){
                        try{
                            while(true){
                                DataInputStream dis = new DataInputStream(Servidor.cliente.getInputStream());
                    ...
                    public void run(){
                        ...
                        try{
                            while(true){                               
                                ...
                                DataOutputStream dos = new DataOutputStream(Servidor.cliente.getOutputStream());
