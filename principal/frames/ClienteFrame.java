...
public class ClienteFrame extends JFrame{
    ...
    public ClienteFrame(){
        ...
        ClienteFrame.botaoEnviar.addActionListener(new ActionListener() {                   
            public void actionPerformed(ActionEvent e) { 
                if(ClienteFrame.cliente != null){
                    try{
                        DataOutputStream dos = new DataOutputStream(ClienteFrame.cliente.getOutputStream());
    ...
    public static void main(String[] args){
        ...
        try {
        	...
        	ClienteFrame.cliente = new Socket("localhost", 1235); 
            ...
            Thread threadDigitadora = new Thread(){
                ...
                public void run(){
                    ...
                    try{
                        while(true){                                                            
                            DataInputStream dis = new DataInputStream(ClienteFrame.cliente.getInputStream());
